const TEMPLATES = [
    ...
    "{I_THINK} {TRACKER} is the GGn of {TRACKER}",
    "{OPENER} {TRACKER} mods just left and joined {TRACKER}",
    "{REVEAL} {TRACKER} mods are secretly in charge of /r/trackers",
...
const TOKENS = {
    ...
    PLACE: [
        ...
        "/ptg",
        "Unraid forums",
        "UNIT3D's GitHub issues",
        "{TRACKER}'s chatbox",
        "people who solved fesxj's ATH profile riddle",
        "autobrr's Discord",
